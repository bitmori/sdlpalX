 ...
 *
 * @param[in] wScreenWidth - width of the screen.
 * @param[in] wScreenHeight - height of the screen.
 * @param[in] fFullScreen - TRUE to use full screen mode, FALSE to use windowed mode.
 *
 * @return None
 */
