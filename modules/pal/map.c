...
/*++
 ...
 [IN]  fpMapMKF - Pointer to the fopen'ed map.mkf file, which contains the map tile data.
 [IN]  fpGopMKF - Pointer to the fopen'ed gop.mkf file, which contains the tile bitmaps. The bitmap can be read by PAL_SpriteGetFrame() function.
...
/*++
 Get the logical height value of the specified tile. This value is used to judge whether the tile bitmap should cover the sprites or not.
