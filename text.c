...
static const char g_rgszAdditionalWords[][WORD_LENGTH + 1] = {
    ...
    // TODO: move extra words to toml
    // below will be the newly added words
    {0xBC, 0xC6, 0xB6, 0x71, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // Amount 0xAD 0xD3||數量 0xBC, 0xC6, 0xB6, 0x71
    {0xBC, 0xC4, 0xB1, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // Enemy Info 情報 0xB1, 0xA1, 0xB3, 0xF8 || 敵情 0xBC, 0xC4, 0xB1, 0xA1
    {0xAC, 0x72, 0xA7, 0xDC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // Poison Resistance 毒抗 0xAC, 0x72, 0xA7, 0xDC
    //{0xA7, 0xAF, 0xA4, 0x4F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // Collectable Monster Power 妖力0xA7, 0xAF, 0xA4, 0x4F
    {0xC6, 0x46, 0xB8, 0xAC, 0xAD, 0xC8, 0x00, 0x00, 0x00, 0x00, 0x00}, // 靈葫值	0xC6, 0x46, 0xB8, 0xAC, 0xAD, 0xC8
    
    {0xB0, 0xBD, 0xC5, 0xD1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // StealItem 偷竊	0xB0, 0xBD, 0xC5, 0xD1
    {0xA7, 0xF0, 0xC0, 0xBB, 0xAE, 0xC4, 0xAA, 0x47, 0x00, 0x00, 0x00}, // Attack Effect 攻擊效果	0xA7, 0xF0, 0xC0, 0xBB, 0xAE, 0xC4, 0xAA, 0x47
    {0xAD, 0xB7, 0xB9, 0x70, 0xA4, 0xF4, 0xA4, 0xF5, 0xA4, 0x67, 0x00}, // 5風雷水火土0xAD, 0xB7, 0xB9, 0x70, 0xA4, 0xF4, 0xA4, 0xF5, 0xA4, 0x67
    {0xA5, 0xC9, 0xAB, 0xD2, 0xBC, 0xD2, 0xA6, 0xA1, 0x00, 0x00, 0x00}, // GodMode玉帝模式	0xA5, 0xC9, 0xAB, 0xD2, 0xBC, 0xD2, 0xA6, 0xA1
    
    {0xB3, 0xC8, 0xC0, 0x77, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // kStatusPuppet, 傀儡	0xB3, 0xC8, 0xC0, 0x77
    {0xA4, 0xD1, 0xD3, 0x5C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // kStatusBravery, 天罡	0xA4, 0xD1, 0xD3, 0x5C
    {0xAA, 0xF7, 0xAD, 0xE8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // kStatusProtect, 金剛	0xAA, 0xF7, 0xAD, 0xE8
    {0xA5, 0x50, 0xAD, 0xB7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // kStatusHaste, 仙風	0xA5, 0x50, 0xAD, 0xB7
    {0xBE, 0x4B, 0xA5, 0x50, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // kStatusDualAttack, 醉仙	0xBE, 0x4B, 0xA5, 0x50
};
#endif
