...
/*++
 Calculate all the tiles which may cover the specified sprite. Add the tiles into our list as well.
...
/*++
 ...
 Parameters:
    ...
    [IN]  fCheckEventObjects - TRUE if check for event objects, FALSE if only check for the map.
